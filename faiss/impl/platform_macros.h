...
#ifdef FAISS_ENABLE_OBFUSCATOR
// 基础混淆: 仅指令替换 (SUB)
#define FAISS_OBFUSCATE __attribute__((__annotate__(("substitution"))))
// 中等混淆: 虚假控制流 + 指令替换 (BCF+SUB)
#define FAISS_OBFUSCATE_BCF __attribute__((__annotate__(("boguscfg,substitution"))))
// 强混淆: BCF + SUB + MBA (线性混合布尔算术)
#define FAISS_OBFUSCATE_STRONG __attribute__((__annotate__(("boguscfg,substitution,linearmba"))))
// 间接跳转混淆: BCF + SUB + 间接分支
#define FAISS_OBFUSCATE_INDBR __attribute__((__annotate__(("boguscfg,substitution,indirectbr"))))
// 最强混淆: BCF + SUB + MBA + 间接分支 (注意: 性能影响较大)
#define FAISS_OBFUSCATE_MAX __attribute__((__annotate__(("boguscfg,substitution,linearmba,indirectbr"))))
// 兼容旧宏: FLA在复杂函数上不稳定，改用 BCF+SUB+MBA 替代
#define FAISS_OBFUSCATE_FLA FAISS_OBFUSCATE_STRONG
#else
#define FAISS_OBFUSCATE
#define FAISS_OBFUSCATE_BCF
#define FAISS_OBFUSCATE_STRONG
#define FAISS_OBFUSCATE_INDBR
#define FAISS_OBFUSCATE_MAX
#define FAISS_OBFUSCATE_FLA
#endif
