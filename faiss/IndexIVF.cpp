...
IndexIVFStats IndexIVF::get_ivf_stats() const {
    return indexIVF_stats;
}
...
void IndexIVFStats::add(const IndexIVFStats& other) {
    ...
    pruning_time += other.pruning_time;
    bound_time += other.bound_time;
    bound_time_ip += other.bound_time_ip;
}
